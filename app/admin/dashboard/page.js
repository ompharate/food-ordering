...
const orders = [
  ...
  { id: 2, customer: "Jane Smith", items: 2, total: 25.98, status: "Processing" },
  { id: 3, customer: "Bob Johnson", items: 1, total: 15.99, status: "Pending" },
  { id: 4, customer: "Alice Brown", items: 4, total: 56.96, status: "Delivered" },
  { id: 5, customer: "Charlie Davis", items: 2, total: 31.98, status: "Processing" },
]
